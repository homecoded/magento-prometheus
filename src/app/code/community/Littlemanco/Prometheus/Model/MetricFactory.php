...
class Littlemanco_Prometheus_Model_MetricFactory
{
     ...
     * @param array  $aArgs Arguments to be passed to the model constructor
     *
     ...
     */
    private function _getInstance($sType, $sName, array $aArgs)
    {
        ...
        switch ($sType) {
            ...
            case Littlemanco_Prometheus_Model_Metrics_Abstract::S_TYPE_COUNTER:
                $oObject = Mage::getModel('littlemanco_prometehus/metrics_counter', $aArgs);
                break;
            default:
